          ...
          {loading ? (
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <p className="text-sm text-gray-500">{request.position || "Employee"}</p>
                        <div className="flex items-center mt-1">
                          <span className="text-xs bg-gray-100 px-2 py-1 rounded-full text-gray-600 mr-2">{request.type}</span>
                          <span className="text-xs text-gray-500">{request.dates || formatDateRange(request.startDate, request.endDate)}</span>
                        </div>
                      </div>
                    </div>
                  ...
                  >
                    <div className="flex items-center">
                      ...
                      <div className="ml-4">
                        ...
                        <div className="flex items-center mt-1">
                          <span className="text-xs bg-gray-100 px-2 py-1 rounded-full text-gray-600 mr-2">{request.leaveType}</span>
            ...
            <div className="bg-white rounded-xl shadow-md overflow-hidden">
              <div className="bg-gray-50 py-3 px-4 border-b border-gray-200 flex">
                <div className="w-1/3 font-medium text-gray-600">Employee</div>
                    ...
                    <div className="flex">
                      <div className="w-1/3 flex items-center">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-gray-500">{item.position || "Employee"}</div>
                        </div>
                      </div>
                      <div className="w-1/3">
                        <div className="text-sm text-gray-700 font-medium">{item.type}</div>
                        <div className="text-xs text-gray-500">{item.dates || formatDateRange(item.startDate, item.endDate)}</div>
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-md relative shadow-xl">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h4 className="font-medium text-gray-800">{selectedRequest.name}</h4>
                  <p className="text-sm text-gray-500">{selectedRequest.position || "Employee"}</p>
                </div>
              </div>
              ...
              <div className="bg-gray-50 p-3 rounded-lg">
                ...
                <p className="text-gray-900">{selectedRequest.dates || formatDateRange(selectedRequest.startDate, selectedRequest.endDate)}</p>
              </div>
